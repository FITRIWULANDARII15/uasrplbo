            ...
            <div class="content-wrapper">
                    ...
                    <div class="container">
                        <div class="row mb-2">
                            <div class="col text-center">
                                <h1 class="m-0">Pendaftaran Vaksin Kedua</h1>
                            </div><!-- /.col -->
                ...
                <div class="content">
                    <div class="container ">
                        ...
                        <form class="pendaftaran" method="post" action="<?= base_url('pendaftaran/daftarvaksin2'); ?>">
                            <div class="row mb-3">
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="jenisvaksin" name="jenisvaksin" 
                                    placeholder="Jenis vaksin saat vaksin pertama" value="<?= set_value('jenisvaksin') ?>">
                                    <?= form_error('jenisvaksin', '<small class="text-danger">', '</small>'); ?>
                                </div>
                            </div>
